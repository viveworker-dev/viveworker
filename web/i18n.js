...
const translations = {
  en: {
    ...
    "settings.remotePairing.title": "Remote relay",
    "settings.remotePairing.subtitle": "Off-LAN access for paired phones",
    "settings.remotePairing.copy": "Lets paired phones reach this Mac when not on the same Wi-Fi. Traffic is end-to-end encrypted; the relay sees only opaque bytes.",
    "settings.remotePairing.toggle.title": "Enable relay",
    "settings.remotePairing.toggle.description": "Open an encrypted tunnel to the relay so paired phones can connect off-LAN.",
    "settings.remotePairing.status.title": "Status",
    "settings.remotePairing.status.disabled": "Off",
    "settings.remotePairing.status.connected": "Connected",
    "settings.remotePairing.status.connecting": "Connecting…",
    "settings.remotePairing.relayUrl.title": "Relay URL",
    "settings.remotePairing.relayUrl.placeholder": "wss://pairing.viveworker.com",
    "settings.remotePairing.relayUrl.help": "Leave blank to use the default. Must start with ws:// or wss://.",
    ...
    "settings.remotePairing.pairings.title": "Paired phones",
    "settings.remotePairing.pairings.empty": "No phones paired yet. Pair on LAN first; that flow lands in a later release.",
    ...
    "settings.remotePairing.error.invalidRelayUrl": "Relay URL must start with ws:// or wss://.",
    ...
    "settings.remotePairing.thisDevice.copy": "This phone is enrolled and can reach the bridge over the relay (when relay is ON).",
    "settings.remotePairing.thisDevice.notEnrolled": "This phone hasn't been registered for relay access yet. Re-pair on LAN to enroll.",
  ...
  ja: {
    ...
    "settings.remotePairing.title": "リモートリレー",
    "settings.remotePairing.subtitle": "ペア済み端末に LAN 外からアクセス",
    "settings.remotePairing.copy": "ペア済みのスマホが同じ Wi-Fi にいない時でもこの Mac に届くようにします。エンドツーエンド暗号化されており、リレーは暗号化されたバイト列しか見えません。",
    "settings.remotePairing.toggle.title": "リレーを有効化",
    "settings.remotePairing.toggle.description": "リレーへの暗号化トンネルを開き、ペア済みのスマホが LAN 外から接続できるようにします。",
    "settings.remotePairing.status.title": "状態",
    "settings.remotePairing.status.disabled": "オフ",
    "settings.remotePairing.status.connected": "接続中",
    "settings.remotePairing.status.connecting": "接続中…",
    "settings.remotePairing.relayUrl.title": "リレー URL",
    "settings.remotePairing.relayUrl.placeholder": "wss://pairing.viveworker.com",
    "settings.remotePairing.relayUrl.help": "空欄でデフォルトを使用。ws:// または wss:// で始める必要があります。",
    ...
    "settings.remotePairing.pairings.title": "ペア済み端末",
    "settings.remotePairing.pairings.empty": "まだペアリング済み端末がありません。ペアリングフローは後続のリリースで提供します。",
    ...
    "settings.remotePairing.error.invalidRelayUrl": "リレー URL は ws:// または wss:// で始める必要があります。",
    ...
    "settings.remotePairing.thisDevice.copy": "この端末はリレー登録済みです。リレーが ON の時に LAN 外からこの Mac に届きます。",
    "settings.remotePairing.thisDevice.notEnrolled": "この端末はまだリレー登録されていません。LAN で再ペアリングすると登録されます。",
