...
const translations = {
  en: {
    ...
    "settings.wallet.subtitle": "hazBase",
    "settings.wallet.copy": "Manage your hazBase sign-in, passkey, and Base wallet addresses.",
    ...
    "settings.wallet.flow.banner.title": "Set up your wallet in order",
    "settings.wallet.flow.copy": "Start at the highlighted step, then move downward. Base Sepolia is the main testing wallet for the current beta.",
    "settings.wallet.ready.title": "Ready to use",
    "settings.wallet.ready.copy": "Your email sign-in, passkey, and Base Sepolia wallet are all set. You can issue a Base mainnet wallet later if you need it.",
    ...
    "settings.wallet.step.signIn.copy": "Send a one-time code to your email, then verify it here to sign in to hazBase.",
    ...
    "settings.hazbase.title": "hazBase Wallet",
    ...
    "settings.hazbase.action.requestOtp": "Send OTP",
    "settings.hazbase.action.verifyOtp": "Verify OTP",
    ...
    "settings.hazbase.action.signOut": "Sign out of hazBase",
    "settings.hazbase.notice.otpRequested": "OTP requested.",
    "settings.hazbase.notice.otpVerified": "Signed in to hazBase.",
    ...
    "settings.hazbase.notice.signedOut": "Signed out of hazBase.",
    "settings.hazbase.prompt.email": "hazBase email address",
    "settings.hazbase.prompt.otp": "OTP code",
    "settings.row.hazbaseStatus": "hazBase",
    "settings.row.hazbaseEmail": "hazBase email",
    ...
    "error.hazbaseAuthRequired": "Sign in to hazBase first.",
  ...
  ja: {
    ...
    "settings.wallet.title": "Wallet",
    "settings.wallet.subtitle": "hazBase",
    "settings.wallet.copy": "hazBase へのサインイン、Passkey、Base 系ウォレットの管理を行います。",
    ...
    "settings.wallet.flow.banner.title": "上から順に設定してください",
    "settings.wallet.flow.copy": "強調されている step から始めて、上から順に進めてください。現在の beta では Base Sepolia が主なテスト用ウォレットです。",
    "settings.wallet.ready.title": "利用準備ができました",
    "settings.wallet.ready.copy": "メールサインイン、Passkey、Base Sepolia ウォレットの準備ができています。Base mainnet は必要になった時に追加で発行できます。",
    ...
    "settings.wallet.step.signIn.copy": "メールにワンタイムコードを送り、そのコードを確認して hazBase にサインインします。",
    ...
    "settings.hazbase.action.requestOtp": "OTP送信",
    "settings.hazbase.action.verifyOtp": "OTP確認",
    ...
    "settings.hazbase.action.signOut": "hazBaseからログアウト",
    "settings.hazbase.notice.otpRequested": "OTPを送信しました。",
    "settings.hazbase.notice.otpVerified": "hazBaseにサインインしました。",
    ...
    "settings.hazbase.notice.signedOut": "hazBaseからログアウトしました。",
    "settings.hazbase.prompt.email": "hazBaseのメールアドレス",
    "settings.hazbase.prompt.otp": "OTPコード",
    "settings.row.hazbaseStatus": "hazBase",
    "settings.row.hazbaseEmail": "hazBaseメール",
    "settings.row.hazbasePasskey": "Passkey",
    ...
    "error.hazbaseAuthRequired": "先に hazBase へサインインしてください。",
